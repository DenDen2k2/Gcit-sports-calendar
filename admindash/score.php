        ...
        <div class="d-flex" id="wrapper">
            <div class="bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush my-3">
                    ...
                    <a href="score.php" class="list-group-item list-group-item-action bg-transparent text-danger second-text fw-bold">    
    ...
    <div class="bg-modal">
        <div class="modal-contents">
            ...
            <form action="scoreform.php" method="post">
                    ...
                    <input type="number" name="scorea" placeholder="Team a Score">
                    ...
                    <input type="number" name="scoreb" placeholder="Team B Score">
