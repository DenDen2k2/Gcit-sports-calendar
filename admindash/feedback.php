        ...
        <div class="d-flex" id="wrapper">
            <div class="bg-white" id="sidebar-wrapper">
                ...
                <div class="list-group list-group-flush my-3">
                    ...
                    <a href="feedback.php" class="list-group-item list-group-item-action bg-transparent text-danger second-text fw-bold">
                    ...
                    <?php
                        ...
                        while($row = $result->fetch_assoc()){
                            if($even%2!=0){
                                ...
                                <input type='hidden' name='id' value='".  $row['feedback id'] ."'>
